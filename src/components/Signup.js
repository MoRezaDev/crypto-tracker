...
const Signup = ({ collapseSignupModal }) => {
  ...
  return (
    <div onClick={collapseSignupModal} className={theme === "light" ? styles.signupContainerModal : `${styles.signupContainerModal} ${styles.darkContainer}`}>
      <div
